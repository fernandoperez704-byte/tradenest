...
export default function GabyIntro({ onStartLesson }: GabyIntroProps) {
  return (
    <div className="relative min-h-[calc(100vh-110px)] overflow-hidden rounded-[32px] border border-cyan-400/20 bg-[#070b14] p-5 lg:p-6 shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
      ...
      <div className="relative grid w-full grid-cols-1 lg:grid-cols-[240px_minmax(0,1fr)] gap-6 items-start">
...
<div className="mt-3 rounded-2xl border border-cyan-400/20 bg-[#0f172a]/80 p-3 text-center">
  <p className="text-sm leading-6 font-black text-cyan-300">
    Gaby guides every lesson, reinforces concepts in Discord, and helps you learn inside the simulator.
        ...
        <div className="animate-[fadeUp_0.8s_ease-out_both]">
          <div className="flex items-center gap-3">
            <p className="text-2xl md:text-3xl font-black tracking-[0.18em] uppercase">
          ...
          <div className="mt-4 grid gap-1">
            <div className="relative rounded-2xl border border-cyan-400/25 bg-[#0f172a]/90 p-4 shadow-[0_0_35px_rgba(34,211,238,0.08)] transition-all duration-300 hover:border-cyan-300/50 hover:shadow-[0_0_45px_rgba(34,211,238,0.16)]">
              ...
              <p className="mt-2 text-zinc-300 text-base leading-7">
...
<div className="mt-3 rounded-2xl border border-cyan-400/20 bg-[#0f172a]/80 p-5">
  ...
  <p className="mt-4 text-zinc-300 text-base leading-7">
...
<p className="text-zinc-400">
  ...
  <p className="mt-4 text-cyan-300 font-black">
